...
The [valuation fixture](https://github.com/heyrafiki/proving-ground/blob/main/fixtures/claim-valuation-timeline.json), [JSON Schema](https://github.com/heyrafiki/proving-ground/blob/main/assurance/claim-valuation-timeline.schema.json) and [conformance test](https://github.com/heyrafiki/proving-ground/blob/main/scripts/check-claim-valuation-timeline.mjs) live in Proving Ground.
