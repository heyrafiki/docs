...
keywords: ["healthcare API Sandbox", "synthetic data", "integration testing"]
---
...
The [Developer Platform](https://app.heyrafiki.space/dev/sandbox) can run documented read requests and shows the response body, request ID, latency and current rate-limit state.
