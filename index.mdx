---
title: "Heyrafiki API introduction and quickstart"
description: "Introduction to the Heyrafiki REST API for mental healthcare: base URL, Bearer authentication, JSON responses and the resources it exposes to developers."
---
