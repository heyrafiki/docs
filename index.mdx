...
The Heyrafiki API exposes Mental Healthcare infrastructure through versioned REST contracts. The sandbox includes Practitioner discovery, Bookings, Benefits, Sessions, Claims, remittance and Webhooks.
