---
title: "Heyrafiki API changelog"
description: "Version history for the Heyrafiki API: new endpoints, resources, webhook events and breaking changes, listed newest first with dated release notes."
rss: true
---
