...
<Note>
  The current SDK and CLI release is source-only. Registry packages and
  versioned GitHub Releases have not been published. Use the reviewed public
  repositories and the build commands below until a release appears in the
  owning repository.
</Note>
