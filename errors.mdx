---
title: "API error codes and status responses"
description: "The Heyrafiki API error envelope, HTTP status codes, stable error codes, WWW-Authenticate details for 401s and retry guidance for 429 and 5xx responses."
---
