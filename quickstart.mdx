...
Open **API Keys** in the [Developer Platform](https://app.heyrafiki.space/dev/keys), create a sandbox key and copy it when shown. [Request access](https://heyrafiki.space/waitlist) if your Organization has not been enabled.
