---
title: "Webhook events, signatures and retries"
description: "Subscribe to Heyrafiki webhook events, verify HMAC-SHA256 signatures over the raw body, handle at-least-once delivery and 24-hour retries idempotently."
---
