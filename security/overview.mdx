...
keywords: ["healthcare API security", "Consent", "purpose-based access control"]
---
...
Send security concerns to security@heyrafiki.space. Do not include passwords, keys, or clinical records in a first message. We acknowledge reports and agree a fix and disclosure timeline with the reporter.
